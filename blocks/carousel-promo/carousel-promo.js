...
export default async function decorate(block) {
  ...
  rows.forEach((row, idx) => {
    ...
    // transfer instrumentation attributes
    [...row.attributes].forEach((attr) => { if (attr.name.startsWith('data-aue-') || attr.name.startsWith('data-richtext-')) slide.setAttribute(attr.name, attr.value); });
